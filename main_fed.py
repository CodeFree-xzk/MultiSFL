...
from Algorithm.Training_MultiSFL import MultiSFL
...
if __name__ == '__main__':
    ...
    net_glob_client = None
    net_glob_server = None
    if args.model == "resnet":
        net_glob_client = ResNet18_client_side()
        net_glob_server = ResNet18_server_side(args)
    elif args.model == "vgg":
        net_glob_client = VGG16_client_side()
        net_glob_server = VGG16_server_side(args)
    ...
    elif args.algorithm == "MultiSFL":
        multisfl = MultiSFL(args, net_glob, dataset_train, dataset_test, dict_users, net_glob_client, net_glob_server)
        multisfl.main()
